    ...
    <div className="min-h-screen bg-slate-950 text-slate-300">
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold text-white mb-3">4. Subscription Terms</h2>
            <h3 className="text-lg font-medium text-white mt-4 mb-2">Billing</h3>
            <p className="leading-relaxed">
            ...
            <h3 className="text-lg font-medium text-white mt-4 mb-2">Price Changes</h3>
            <p className="leading-relaxed">
